...
class ArticleRecord extends DataClass implements Insertable<ArticleRecord> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || publishDate != null) {
      map['publish_data'] = Variable<String>(publishDate);
    }
  ...
  ArticleRecordsCompanion toCompanion(bool nullToAbsent) {
    return ArticleRecordsCompanion(
      ...
      urlToImage: urlToImage == null && nullToAbsent
          ? const Value.absent()
          : Value(urlToImage),
      publishData: publishDate == null && nullToAbsent
          ? const Value.absent()
          : Value(publishDate),
  ...
  factory ArticleRecord.fromJson(Map<String, dynamic> json,
    ...
    return ArticleRecord(
      ...
      publishDate: serializer.fromJson<String>(json['publishData']),
  ...
  Map<String, dynamic> toJson({ValueSerializer serializer}) {
    ...
    return <String, dynamic>{
      ...
      'publishData': serializer.toJson<String>(publishDate),
  ...
  ArticleRecord copyWith(
      ...
      ArticleRecord(
        ...
        publishDate: publishData ?? this.publishDate,
